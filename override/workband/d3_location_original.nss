...
void main() {
    ...
    string BringDeg=FloatToString(Bearing*180/PI, 5, 5);
    string NBringDeg=FloatToString(Nbearing*180/PI, 5, 5);


    string Output = "Beginning whereami output:";
    string Module="Module: " + currentMod;

    string scos = FloatToString(cos((Bearing*180/PI-90.0)/2), 9, 9);
    string ssin = FloatToString(sin((Bearing*180/PI-90.0)/2), 9, 9);
    string sncos = FloatToString(cos((Nbearing*180/PI-90.0)/2), 9, 9);
    string snsin = FloatToString(sin((Nbearing*180/PI-90.0)/2), 9, 9);
    ...
    string PlayerPosition ="> " +  X_Coordinate + "> " + Y_Coordinate + "> " + Z_Coordinate + "> " +"XOrientation: " + XOrientation + "> " +"YOrientation: " + YOrientation + "> " +"Bearing: " + Bring + "> Degrees: " + BringDeg + "> Cos: " + scos + "> Sin: " + ssin;
    string NplayerPosition ="> " +  X_Coordinate + "> " + Y_Coordinate + "> " + Z_Coordinate + "> " +"XOrientation: " + XOrientation + "> " +"YOrientation: " + YOrientation + "> " +"Bearing: " + Nbring + "> Degrees: " + NBringDeg + "> Cos: " + sncos + "> Sin: " + snsin;
...
// -- tk102
    ...
    //DelayCommand(2.0, ShowSwoopUpgradeScreen());
}
