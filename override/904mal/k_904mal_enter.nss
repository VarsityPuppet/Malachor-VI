...
void Run904Plan(){
	...
	object oConvo = CreateObject(OBJECT_TYPE_PLACEABLE, "p_904plan", Location(Vector(0.0, 0.0, -15.0), 0.0), 0);

	SetGlobalNumber("907MAL_CUTSCENE", 5);
	AssignCommand(oConvo, ActionStartConversation(oConvo, "904plan", 0, 0, 0, "", "", "", "", "", "", 0, 0xFFFFFFFF, 0xFFFFFFFF, 0));
...
void AttSion(){
	...
	SetGlobalNumber("907MAL_CUTSCENE", 5);
	SetLightsaberPowered(GetObjectByTag("DarthSion"), TRUE, TRUE, FALSE);
