...
int param1 = GetScriptParameter(1);
	...
	switch(param1){
		...
		case 0:
			SpawnAvailableNPC(4, Location(Vector(1.83571, -85.09681, 0.79600), -90.0));
		...
		case 2:
			...
			SpawnAvailableNPC(7, Location(Vector(0.22363, -85.33105, 0.79600), -90.0));
		...
		break;
		case 4:
			SpawnAvailableNPC(9, Location(Vector(3.32801, -84.84205, 0.79600), -90.0));
		break;
		case 5:
		...
		break;
		case 7:
			SpawnAvailableNPC(0, Location(Vector(-1.06933, -85.48196, 0.79600), -90.0));
