...
//Participants
	...
	if(GetIsObjectValid(GetObjectByTag("sith_assassin", 0))){
		oAss1 = GetObjectByTag("sith_assassin", 0);
		oAss2 = GetObjectByTag("sith_assassin", 1);
		oAss3 = GetObjectByTag("sith_assassin", 2);
	}
...
//The scene
	...
	switch(iParam){
		case 0: 	//Atton defeats Sion
			...
			DelayCommand(8.5, AssignCommand(oSion, ActionPlayAnimation(26, 1.0, 9.9)));
			...
			DelayCommand(12.0, SetDialogPlaceableCamera(iCamera3));
			DelayCommand(12.5, AssignCommand(oAtton, ActionMoveToLocation(GetLocation(GetObjectByTag("wp_avs_atton_2", 0)), TRUE)));

			DelayCommand(15.5, SetDialogPlaceableCamera(iCamera4));
			DelayCommand(17.0, DestroyObject(oAtton));
			DelayCommand(21.0, AssignCommand(oSion, ActionPlayAnimation(ANIMATION_LOOPING_LISTEN_INJURED, 1.0, 1.9)));

			DelayCommand(23.0, AssignCommand(oSion, ActionPlayAnimation(ANIMATION_FIREFORGET_SCREAM)));
		...
		case 5: 	//Sion pride do centra
			...
			oAss1 = CreateObject(OBJECT_TYPE_CREATURE, "g_sith_assassin", GetLocation(GetObjectByTag("wp_pfc_assassin_1", 0)));
			oAss2 = CreateObject(OBJECT_TYPE_CREATURE, "g_sith_assassin", GetLocation(GetObjectByTag("wp_pfc_assassin_2", 0)));
			oAss3 = CreateObject(OBJECT_TYPE_CREATURE, "g_sith_assassin", GetLocation(GetObjectByTag("wp_pfc_assassin_3", 0)));
			...
			object oAss5 = CreateObject(OBJECT_TYPE_CREATURE, "g_sith_assassin", Location(Vector(3.83530, -15.35088, 0.47460), -138.56239430105289233882235365779));
			...
			DelayCommand(18.0, DestroyObject(oAss5));
