void main() {
	...
	switch (nParam1) {
		...
		case 3:
			...
			break;
		case 4:
			DelayCommand(1.5, DestroyObject(GetObjectByTag("Mira", 0), 0.0, 0, 0.0, 0));
			DelayCommand(1.0, DestroyObject(GetObjectByTag("Hanharr", 0), 0.0, 0, 0.0, 0));
			AssignCommand(GetObjectByTag("ebo_hatch"),ActionStartConversation(GetFirstPC(), "901start", 0, 0, 1, "", "", "", "", "", "", 0, 0xFFFFFFFF, 0xFFFFFFFF, 0));
			break;
	}
}
